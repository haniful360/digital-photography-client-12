...
useEffect(() => {
    ...
    return (
        <div className='shadow-md h-20 flex'>
            <div className="navbar z-10 max-w-6xl mx-auto ">
                <div className="navbar-start ">
                    ...
                    <Link to='/' className=" flex items-center text-xl">
                        ...
                        <span className='hidden md:block '>Digital Photography</span>
                    </Link>
                </div>
                ...
                <div className="navbar-end flex gap-4">
                    ...
                    </div> : <Link to='/login' className="btn bg-[#002D74] text-white text-[19px] hover:bg-[#002D74] capitalize tracking-wider">Login</Link>
                    }
